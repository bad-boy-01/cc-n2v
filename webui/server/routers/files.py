...
async def upload_style_image(project_name: str, file: UploadFile = File(...)):
    ...
    try:
        ...
        # AI analysis is disabled in the free Kaggle pipeline.
        # User must provide manual description via the WebUI.
        style_description = "Manual style description required."
